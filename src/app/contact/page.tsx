...
const socialLinks = [
  ...
  { 
    label: 'LinkedIn', 
    href: 'https://linkedin.com/in/sadok-dridi',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <main className="pt-24 sm:pt-28 md:pt-32 pb-16 md:pb-20">
        ...
        <section className="container mx-auto px-4 sm:px-6 md:px-12 mb-12 md:mb-20">
          ...
          <TextReveal
            as="h1"
            animation="words"
            className="mt-3 md:mt-4 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white"
            trigger="load"
            delay={0.4}
          >
            Let&apos;s work together
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 lg:gap-24">
            ...
            <div className="space-y-8 md:space-y-12">
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <a 
                  href="mailto:sadok.dridi@esprit.tn"
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-sm sm:text-base text-white group-hover:text-cyan-400 transition-colors truncate">sadok.dridi@esprit.tn</div>
                  </div>
                </a>
